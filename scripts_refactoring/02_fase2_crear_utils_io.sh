#!/bin/bash
# ==============================================================================
# FASE 2: Crear utils/io.R para funciones I/O compartidas
# ==============================================================================
...
echo "[1/2] Creando utils/io.R..."

# Crear archivo utils/io.R
cat > utils/io.R << 'ENDOFFILE'
# ==============================================================================
# UTILS: INPUT/OUTPUT
...
echo "✓ Archivo creado: utils/io.R"

echo ""
echo "[2/2] Verificando archivo creado..."
if [ -f "utils/io.R" ]; then
    LINEAS=$(wc -l < utils/io.R)
    TAMAÑO=$(du -h utils/io.R | cut -f1)
    echo "  ✓ utils/io.R existe ($LINEAS líneas, $TAMAÑO)"
else
    echo "  ❌ Error al crear utils/io.R"
    exit 1
fi
...
echo ""
echo "Archivo creado:"
echo "  • utils/io.R (funciones I/O centralizadas)"
echo ""
echo "Funciones disponibles:"
echo "  • exportar_csv(df, nombre, carpeta)"
echo "  • guardar_resultados(lista, carpeta)"
echo "  • cargar_resultados(archivos, carpeta)"
echo "  • verificar_archivos(archivos, carpeta)"
echo ""
echo "Próximo paso opcional:"
echo "  Modificar archivos que definen exportar_csv() localmente"
echo "  para usar esta versión centralizada"
echo ""
echo "Para testing rápido:"
echo "  Rscript -e \"source('utils/io.R'); print('OK')\""
echo ""
